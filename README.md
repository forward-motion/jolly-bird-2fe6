...
```
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-bird-2fe6
```

## Preview Deployment

A live public deployment of this template is available at [https://jolly-bird-2fe6.templates.workers.dev](https://jolly-bird-2fe6.templates.workers.dev)
